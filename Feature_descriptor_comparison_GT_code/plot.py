...
archivo_excel = 'analisi_04.06.2023_trad.xlsx'
...
claves_detect_real=[]
colores_real=[]
nom_eix_y={'n_kpA':'#kpA', 'n_kpB':'#kpB', 'n_matches':'#matches', 'n_inliers':'#inliers', 'matching_hability':'MA (%)', 'recall':'Recall (%)', 'precision':'Precision (%)', 'repetivitat':'Repeatibility (%)', 'dist_projeccions':'Precision (%)', 'p_random_punts_H':'TD (%)',  'esparcitatA': 'Standard deviation', 'esparcitatB':'Standard deviation', 'temps':'Time (ms)'}
...
nom_title={'dist_projeccions':'Precision for different thresholds', 'p_random_punts_H':'TD for different thresholds'}
